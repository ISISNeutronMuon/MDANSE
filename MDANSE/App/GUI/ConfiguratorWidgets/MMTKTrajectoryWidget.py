...
from MDANSE.App.GUI.ConfiguratorWidgets.IConfiguratorWidget import IConfiguratorWidget, ConfiguratorWidgetError

class MMTKTrajectoryWidget(IConfiguratorWidget):
    ...
    def get_widget_value(self):
        ...
        if not filename:
            raise ConfiguratorWidgetError("No MMTK trajectory file selected", self)
