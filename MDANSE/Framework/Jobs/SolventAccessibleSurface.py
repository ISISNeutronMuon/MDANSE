...
class SolventAccessibleSurface(IJob):
    ...
    * Shrake, A., and J. A. Rupley. JMB (1973) 79:351-371.
    ...
    configurators['frames'] = ('frames', {'dependencies':{'trajectory':'trajectory'}, 'default':(0,2,1)})
    configurators['atom_selection'] = ('atom_selection', {'dependencies':{'trajectory':'trajectory'}})
    configurators['n_sphere_points'] = ('integer', {'mini':1, 'default':1000})
    configurators['probe_radius'] = ('float', {'mini':0.0, 'default':0.14})
