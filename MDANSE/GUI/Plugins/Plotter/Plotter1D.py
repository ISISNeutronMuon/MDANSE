...
from MDANSE.GUI.Plugins.Plotter.Settings import LinesSettingsDialog, GeneralSettingsDialog, AxesSettingsDialog
from MDANSE.GUI.Plugins.Plotter.Ticker import ScaledFormatter, ScaledLocator
