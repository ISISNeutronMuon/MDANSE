...
EXTENSIONS = [Extension('atoms_in_shell',
              ...
              Extension('atomic_trajectory',
                        include_dirs=INCLUDE_DIR,
                        sources = ['atomic_trajectory.pyx']),                        
              Extension('fold_coordinates',
                        include_dirs=INCLUDE_DIR,
                        sources = ['fold_coordinates.pyx']),                        
              Extension('com_trajectory',
                        include_dirs=INCLUDE_DIR,
                        sources = ['com_trajectory.pyx']),                        
              Extension('contiguous_coordinates',
                        include_dirs=INCLUDE_DIR,
