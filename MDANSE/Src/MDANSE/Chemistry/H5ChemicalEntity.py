...
class H5AtomCluster(_H5ChemicalEntity):
    ...
    def build(self):
        ...
        for atom_index in self._atom_indexes:
            h5_atom_instance = eval(
                self._h5_contents["atoms"][atom_index],
                globals(),
                {"self": self, "h5_contents": self._h5_contents},
            )
...
class H5PeptideChain(_H5ChemicalEntity):
    ...
    def build(self):
        ...
        for res_index in self._res_indexes:
            h5_residue_instance = eval(
                self._h5_contents["residues"][res_index],
                globals(),
                {"self": self, "h5_contents": self._h5_contents},
            )
...
class H5NucleotideChain(_H5ChemicalEntity):
    ...
    def build(self):
        ...
        for nucl_index in self._nucl_indexes:
            h5_nucleotide_instance = eval(
                self._h5_contents["nucleotides"][nucl_index],
                globals(),
                {"self": self, "h5_contents": self._h5_contents},
            )
...
class H5Protein(_H5ChemicalEntity):
    ...
    def build(self):
        ...
        for pc_index in self._peptide_chain_indexes:
            h5_peptide_chain_instance = eval(
                self._h5_contents["peptide_chains"][pc_index],
                globals(),
                {"self": self, "h5_contents": self._h5_contents},
            )
