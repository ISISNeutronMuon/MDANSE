...
from qtpy.QtWidgets import QDialog, QPushButton, QFrame, QGridLayout,\
                           ...
                           QSizePolicy, QMenu, QLineEdit, QListView
...
class UnitModel(QStandardItemModel):
    ...
    def addNewUnit(self, info: dict):
        ...
        if UNITS_MANAGER.has_unit(unit_name):
             ...
             *[info[key] for key in ['factor','kg','m','s',
                                     'K','mol','A','cd','rad','sr']])
            UNITS_MANAGER.save()
