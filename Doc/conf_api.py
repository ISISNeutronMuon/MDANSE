...
major, minor, _, _, _ = sphinx.version_info
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.viewcode', 'sphinx.ext.graphviz', 'sphinx.ext.inheritance_diagram''sphinx.ext.pngmath' if minor <= 6 else 'sphinx.ext.imgmath']
