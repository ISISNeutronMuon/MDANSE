...
# removed -> qh_dgetrf, qh_dgetrs, qh_dgecon not used anymore
...
# _get_barycentric_transforms function removed (lapack dependency inacceptable)
...
class Delaunay(_QhullUser):
    ...
    def transform(self):
        ...
        if self._transform is None:
            raise Exception('deprecated function : lapack dependency inacceptable')
...
#     cdef np.ndarray[np.double_t, ndim=3] transform
    ...
    if compute_transform:
        print('Transformation impossible : Function inactivated')
