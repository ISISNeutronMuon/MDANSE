...
parameters['options'] = {'ncount': 10000, 'dir': '/users/pellegrini/workspace/MDANSE/Tests/FunctionalTests/Jobs/mcstas_output/10.06.2015-17:13:40'}
...
job = REGISTRY['job']['mvi'](status=False)
job.run(parameters)