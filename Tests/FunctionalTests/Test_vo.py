...
class TestVO(unittest.TestCase):
    ...
    def test_vo(self):
        ...
        reference_data_path = "C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/vo"
        ...
        self.assertTrue(compare("C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/vo_reference.nc", reference_data_path + "_mono" + ".nc"))
