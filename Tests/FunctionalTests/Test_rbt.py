...
class TestRBT(unittest.TestCase):
    ...
    def test_rbt(self):
        ...
        reference_data_path = "C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/rbt"
        ...
        self.assertTrue(compare("C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/rbt_reference.nc", reference_data_path + "_mono" + ".nc"))
