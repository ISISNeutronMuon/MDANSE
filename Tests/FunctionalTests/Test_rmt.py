...
class TestRMT(unittest.TestCase):
    ...
    def test_rmt(self):
        ...
        reference_data_path = "C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/rmt"
        ...
        self.assertTrue(compare("C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/rmt_reference.nc", reference_data_path + "_mono" + ".nc"))
