...
class TestCHARMM(unittest.TestCase):
    ...
    def test_charmm(self):
        ...
        reference_data_path = "C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/charmm"
        ...
        self.assertTrue(compare("C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/charmm_reference.nc", reference_data_path + "_mono" + ".nc"))
