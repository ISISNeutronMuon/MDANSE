...
class TestNDTSF(unittest.TestCase):
    ...
    def test_ndtsf(self):
        ...
        job = REGISTRY['job']['ndtsf']()
        output_path = parameters["output_files"][0]
        reference_data_path = "C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/ndtsf"
        ...
        self.assertTrue(compare("C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/ndtsf_reference.nc", reference_data_path + "_mono" + ".nc"))

        print "Comparing multiprocessor output with reference output"
        self.assertTrue(compare("C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/ndtsf_reference.nc", reference_data_path + "_multi" + ".nc"))
...
def suite():
    ...
    s.addTest(loader.loadTestsFromTestCase(TestNDTSF))
    return s
