...
class TestSFFSF(unittest.TestCase):
    ...
    def test_sffsf(self):
        ...
        reference_data_path = "C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/sffsf"
        ...
        self.assertTrue(compare("C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/sffsf_reference.nc", reference_data_path + "_mono" + ".nc"))
