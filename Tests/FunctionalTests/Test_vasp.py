...
class TestVASP(unittest.TestCase):
    ...
    def test_vasp(self):
        ...
        reference_data_path = "C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/vasp"
        ...
        self.assertTrue(compare("C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/vasp_reference.nc", reference_data_path + "_mono" + ".nc"))
