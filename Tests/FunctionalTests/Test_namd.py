...
class TestNAMD(unittest.TestCase):
    ...
    def test_namd(self):
        ...
        reference_data_path = "C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/namd"
        ...
        self.assertTrue(compare("C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/namd_reference.nc", reference_data_path + "_mono" + ".nc"))
