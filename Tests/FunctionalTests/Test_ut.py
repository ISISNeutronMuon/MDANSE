...
class TestUT(unittest.TestCase):
    ...
    def test_ut(self):
        ...
        reference_data_path = "C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/ut"
        ...
        self.assertTrue(compare("C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/ut_reference.nc", reference_data_path + "_mono" + ".nc"))
