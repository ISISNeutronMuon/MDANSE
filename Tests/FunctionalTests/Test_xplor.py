...
class TestXPLOR(unittest.TestCase):
    ...
    def test_xplor(self):
        ...
        reference_data_path = "C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/xplor"
        ...
        self.assertTrue(compare("C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/xplor_reference.nc", reference_data_path + "_mono" + ".nc"))
