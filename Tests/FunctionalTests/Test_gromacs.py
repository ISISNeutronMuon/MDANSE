...
class TestGROMACS(unittest.TestCase):

    def test_gromacs(self):
        parameters = {}
        parameters['fold'] = False
        parameters['output_files'] = ('c:/users/dni83241/appdata/local/temp/output', ['netcdf'])
        parameters['pdb_file'] = '../../../Data/Trajectories/Gromacs/md.pdb'
        parameters['xtc_file'] = '../../../Data/Trajectories/Gromacs/md.xtc'
        job = REGISTRY['job']['gromacs']()
        output_path = parameters["output_files"][0]
        reference_data_path = "C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/gromacs"
        ...
        self.assertTrue(compare("C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/gromacs_reference.nc", reference_data_path + "_mono" + ".nc"))
...
def suite():
    ...
    s.addTest(loader.loadTestsFromTestCase(TestGROMACS))
    return s
