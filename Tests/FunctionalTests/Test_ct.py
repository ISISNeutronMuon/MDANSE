...
class TestCT(unittest.TestCase):
    ...
    def test_ct(self):
        ...
        reference_data_path = "C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/ct"
        ...
        self.assertTrue(compare("C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/ct_reference.nc", reference_data_path + "_mono" + ".nc"))
