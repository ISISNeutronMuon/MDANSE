...
class TestDFTB(unittest.TestCase):
    ...
    def test_dftb(self):
        ...
        reference_data_path = "C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/dftb"
        ...
        self.assertTrue(compare("C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/dftb_reference.nc", reference_data_path + "_mono" + ".nc"))
