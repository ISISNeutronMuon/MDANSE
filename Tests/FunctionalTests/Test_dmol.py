...
class TestDMOL(unittest.TestCase):
    ...
    def test_dmol(self):
        ...
        reference_data_path = "C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/dmol"
        ...
        self.assertTrue(compare("C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/dmol_reference.nc", reference_data_path + "_mono" + ".nc"))
