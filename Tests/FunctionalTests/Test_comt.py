...
class TestCOMT(unittest.TestCase):
    ...
    def test_comt(self):
        ...
        reference_data_path = "C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/comt"
        ...
        self.assertTrue(compare("C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/comt_reference.nc", reference_data_path + "_mono" + ".nc"))
