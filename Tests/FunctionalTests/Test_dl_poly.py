...
class TestDL_POLY(unittest.TestCase):

    def test_dl_poly(self):
        parameters = {}
        ...
        reference_data_path = "C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/dl_poly"
        ...
        self.assertTrue(compare("C:/Users/dni83241/Documents/MDANSE/MDANSE/Data/Jobs_reference_data/dl_poly_reference.nc", reference_data_path + "_mono" + ".nc"))
