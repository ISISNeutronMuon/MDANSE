...
class TestConfigurator(unittest.TestCase):
    ...
    def test_atom_selection(self):
        ...
        self._configurable.set_settings({"trajectory":('mmtk_trajectory',{}),"atom_selection":('atom_selection',{'dependencies':{'trajectory':'trajectory'}})})
        ...
        self.assertRaises(AtomSelectionParserError,self._configurable.setup,self._parameters)
    ...
    def test_atom_transmutation(self):
        ...
        self._configurable.set_settings({"trajectory":('mmtk_trajectory',{}),
                                         ...
                                         "atom_transmutation":('atom_transmutation',{'dependencies':{'trajectory':'trajectory','atom_selection':'atom_selection'}})})
