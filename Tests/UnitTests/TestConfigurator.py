...
class TestConfigurator(UnitTest):
    ...
    def test_atom_selection(self):
        ...
        configurable.setup(self._parameters)
        self.assertEqual(configurable['atom_selection']['n_selected_atoms'],configurable['trajectory']['instance'].universe.numberOfAtoms())
    ...
    def test_atom_transmutation(self):
        ...
        self._configurableClass.set_settings({"trajectory":('mmtk_trajectory',{}),
                                             "atom_selection":('atom_selection',{'dependencies':{'trajectory':'trajectory'}}),
                                             "atom_transmutation":('atom_transmutation',{'dependencies':{'trajectory':'trajectory',
