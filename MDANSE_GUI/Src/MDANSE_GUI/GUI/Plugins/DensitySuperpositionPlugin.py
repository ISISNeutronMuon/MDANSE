...
class DensitySuperpositionPlugin(ComponentPlugin):
    ...
    def build_panel(self):
        ...
        self.dim = wx.TextCtrl(
            self._mainPanel, wx.ID_ANY, style=wx.SL_HORIZONTAL | wx.TE_READONLY
        )
        ...
        self.opacity = wx.TextCtrl(
            self._mainPanel, wx.ID_ANY, style=wx.SL_HORIZONTAL | wx.TE_PROCESS_ENTER
        )
        ...
        gbSizer.Add(
            isovSizer, (3, 0), span=(3, 4), flag=wx.ALIGN_CENTER_VERTICAL | wx.EXPAND
        )
    ...
    def on_browse(self, event):
        ...
        dialog = wx.FileDialog(
            None, message="Open file...", wildcard=filters, style=wx.MULTIPLE
        )
    ...
    def select_file(self, filename):
        ...
        if "molecular_trace" not in variables:
            raise DensitySuperpositionError(
                "Trace file format not compatible with Plugin"
            )
