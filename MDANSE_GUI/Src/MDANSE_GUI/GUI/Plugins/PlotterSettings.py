...
class ImageSettingsDialog(wx.Dialog, UnitsSettingsDialog):
    ...
    def build_dialog(self):
        ...
        self.title_label = wx.StaticText(
            self, label="Title", style=wx.ALIGN_CENTER_VERTICAL
        )
        self.title = wx.TextCtrl(
            self, wx.ID_ANY, style=wx.SL_HORIZONTAL | wx.TE_PROCESS_ENTER
        )

        self.Xlabel_label = wx.StaticText(
            self, label="X Axis", style=wx.ALIGN_CENTER_VERTICAL
        )
        self.Xlabel = wx.TextCtrl(
            self, wx.ID_ANY, style=wx.SL_HORIZONTAL | wx.TE_PROCESS_ENTER
        )

        self.Ylabel_label = wx.StaticText(
            self, label="Y Axis", style=wx.ALIGN_CENTER_VERTICAL
        )
        self.Ylabel = wx.TextCtrl(
            self, wx.ID_ANY, style=wx.SL_HORIZONTAL | wx.TE_PROCESS_ENTER
        )
        ...
        self.aspect_label = wx.StaticText(
            self, label="Proportions", style=wx.ALIGN_CENTER_VERTICAL
        )
        self.aspect = wx.ComboBox(
            self, id=wx.ID_ANY, choices=self.aspect_choices, style=wx.CB_READONLY
        )

        self.interpolation_label = wx.StaticText(
            self, label="Interpolation", style=wx.ALIGN_CENTER_VERTICAL
        )
        self.interpolation = wx.ComboBox(
            self, id=wx.ID_ANY, choices=self.interpolation_choices, style=wx.CB_READONLY
        )

        self.norm_label = wx.StaticText(
            self, label="Scale", style=wx.ALIGN_CENTER_VERTICAL
        )
        self.normType = wx.ComboBox(
            self, id=wx.ID_ANY, choices=self.norm_choices, style=wx.CB_READONLY
        )
    ...
    def set_settings(self, event=None):
        ...
        if (
            ...
            or self.parent.Yunit != self.Yunit.GetValue()
        ):
            self.parent.Xunit = self.Xunit.GetValue()
...
class GeneralSettingsDialog(wx.Dialog):
    ...
    def build_dialog(self):
        ...
        self.legend_location_label = wx.StaticText(
            self, label="Location", style=wx.ALIGN_CENTER_VERTICAL
        )
        self.legend_location = wx.ComboBox(
            self,
            id=wx.ID_ANY,
            choices=self.legend_location_choice,
            style=wx.CB_READONLY,
        )
        self.legend_location.SetValue(self.legend_location_choice[0])
        self.legend_style_label = wx.StaticText(
            self, label="Style", style=wx.ALIGN_CENTER_VERTICAL
        )
        ...
        self.grid_syle_label = wx.StaticText(
            self, label="Style", style=wx.ALIGN_CENTER_VERTICAL
        )
        self.grid_style = wx.ComboBox(
            self, id=wx.ID_ANY, choices=self.style_choice, style=wx.CB_READONLY
        )

        self.grid_style.SetValue(self.style_choice[-1])

        self.grid_width_label = wx.StaticText(
            self, label="Width", style=wx.ALIGN_CENTER_VERTICAL
        )
        self.grid_width = wx.SpinCtrl(self, id=wx.ID_ANY, style=wx.SP_ARROW_KEYS)

        self.grid_color_label = wx.StaticText(
            self, label="Color", style=wx.ALIGN_CENTER_VERTICAL
        )
        ...
        hsizer5.Add(
            self.apply_button,
            0,
            wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALIGN_RIGHT,
            0,
        )
    ...
    def get_settings(self, event=None):
        ...
        self.grid_color_picker.SetColour(
            wx.Colour(
                int(self.parent.gridColor[0] * 255),
                int(self.parent.gridColor[1] * 255),
                int(self.parent.gridColor[2] * 255),
            )
        )
    ...
    def update_currentFig_grid(self):
        ...
        rvb_color = (color.Red() / 255.0, color.Green() / 255.0, color.Blue() / 255.0)
...
class AxesSettingsDialog(wx.Dialog, UnitsSettingsDialog):
    ...
    def build_dialog(self):
        ...
        self.Xmin_label = wx.StaticText(
            self, label="X Min", style=wx.ALIGN_CENTER_VERTICAL
        )
        self.Xmin = wx.TextCtrl(
            self, wx.ID_ANY, style=wx.SL_HORIZONTAL | wx.TE_PROCESS_ENTER
        )

        self.Ymin_label = wx.StaticText(
            self, label="Y Min", style=wx.ALIGN_CENTER_VERTICAL
        )
        self.Ymin = wx.TextCtrl(
            self, wx.ID_ANY, style=wx.SL_HORIZONTAL | wx.TE_PROCESS_ENTER
        )

        self.Xmax_label = wx.StaticText(
            self, label="X Max", style=wx.ALIGN_CENTER_VERTICAL
        )
        self.Xmax = wx.TextCtrl(
            self, wx.ID_ANY, style=wx.SL_HORIZONTAL | wx.TE_PROCESS_ENTER
        )

        self.Ymax_label = wx.StaticText(
            self, label="Y Max", style=wx.ALIGN_CENTER_VERTICAL
        )
        self.Ymax = wx.TextCtrl(
            self, wx.ID_ANY, style=wx.SL_HORIZONTAL | wx.TE_PROCESS_ENTER
        )
        ...
        self.Xscale_label = wx.StaticText(
            self, label="X", style=wx.ALIGN_CENTER_VERTICAL
        )
        self.Xscale = wx.ComboBox(
            self, id=wx.ID_ANY, choices=self.axis_scales_choices, style=wx.CB_READONLY
        )
        ...
        self.Yscale_label = wx.StaticText(
            self, label="Y", style=wx.ALIGN_CENTER_VERTICAL
        )
        self.Yscale = wx.ComboBox(
            self, id=wx.ID_ANY, choices=self.axis_scales_choices, style=wx.CB_READONLY
        )
    ...
    def set_settings(self, event=None):
        ...
        self.parent.figure.gca().axis(
            [self.parent.Xmin, self.parent.Xmax, self.parent.Ymin, self.parent.Ymax]
        )
...
class LinesSettingsDialog(wx.Dialog):
    ...
    def build_dialog(self):
        ...
        self.color_label = wx.StaticText(
            self, label="Color", style=wx.ALIGN_CENTER_VERTICAL
        )
        self.color_picker = wx.ColourPickerCtrl(self, id=wx.ID_ANY, col="black")

        self.legend_label = wx.StaticText(
            self, label="Legend", style=wx.ALIGN_CENTER_VERTICAL
        )
        self.legend = wx.TextCtrl(
            self, wx.ID_ANY, style=wx.SL_HORIZONTAL | wx.TE_PROCESS_ENTER
        )

        self.style_label = wx.StaticText(
            self, label="Style", style=wx.ALIGN_CENTER_VERTICAL
        )
        self.style = wx.ComboBox(
            self, id=wx.ID_ANY, choices=self.style_choice, style=wx.CB_READONLY
        )

        self.width_label = wx.StaticText(
            self, label="Width", style=wx.ALIGN_CENTER_VERTICAL
        )
    ...
    def set_lines(self):
        ...
        for k in list(self.parent.plots.keys()):
            if type(self.parent.plots[k][0].get_color()) is str:
                try:
                    r, g, b = matplotlib.colors.colorConverter.colors[
                        self.parent.plots[k][0].get_color()
                    ]
                except KeyError:
