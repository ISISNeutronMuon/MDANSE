...
class WorkingPanel(wx.Panel):
    def __init__(self, parent):
        ...
        self._notebook.Bind(
            wxaui.EVT_AUINOTEBOOK_PAGE_CLOSE, self.on_close_page, self._notebook
        )
    ...
    def on_close_page(self, event):
        d = wx.MessageDialog(
            None,
            "Closing this data will also close all the other plugins you plugged in in so far. Do you really want to close ?",
            "Question",
