...
from MDANSE_GUI.Plotter.dialogs.slice_viewer_dialog import SliceViewerDialog
from MDANSE_GUI.Plotter.dialogs.plot_nd_axis_settings_dialog import (
    PlotNDAxisSettingsDialog,
)
from MDANSE_GUI.Plotter.dialogs.plot_nd_general_settings_dialog import (
    PlotNDGeneralSettingsDialog,
)
from MDANSE_GUI.Plotter.dialogs.plot_nd_image_settings_dialog import (
