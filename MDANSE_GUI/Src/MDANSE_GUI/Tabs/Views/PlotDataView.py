...
def projection_datasets_from_qarray(
    ...
    projection_ac = SingleDataset(
        ...
        marker="v",
        data=None,
        plot_axes={"q_x": q_array[0, :], "q_z": q_array[2, :]},
        axes_units={"q_x": "1/ang", "q_z": "1/ang"},
        data_unit="1/ang",
        optional_filename=filename,
    )
    projection_bc = SingleDataset(
        ...
        marker="s",
        data=None,
        plot_axes={"q_y": q_array[1, :], "q_z": q_array[2, :]},
        axes_units={"q_y": "1/ang", "q_z": "1/ang"},
        data_unit="1/ang",
        optional_filename=filename,
    )
    full_vectors = SingleDataset(
        ...
        marker="o",
        data=None,
        plot_axes={"q_x": q_array[0, :], "q_y": q_array[1, :], "q_z": q_array[2, :]},
        axes_units={"q_x": "1/ang", "q_y": "1/ang", "q_z": "1/ang"},
        data_unit="1/ang",
        optional_filename=filename,
    )
