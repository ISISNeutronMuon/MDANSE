...
from MDANSE_GUI.PyQtGUI.pygenplot.views.table_views import QTableViewWithoutRightClick
from MDANSE_GUI.PyQtGUI.pygenplot.widgets.range_slider import RangeSlider
