...
class StaticFancyText(wxfancytext.StaticFancyText):
    ...
    def SetLabel(self, label):
        ...
        bmp = wxfancytext.RenderToBitmap(
            label, wx.Brush(self.GetParent().GetBackgroundColour(), wx.SOLID)
        )
...
class ElementInfoFrame(wx.Frame):
    ...
    def __init__(self, parent, element, *args, **kwds):
        ...
        wx.Frame.__init__(
            ...
            parent,
            wx.ID_ANY,
            title="Information about %s element" % element,
        ...
        hyperlink = wx.HyperlinkCtrl(
            mainPanel,
            wx.ID_ANY,
            label="More about %s" % ATOMS_DATABASE[element]["element"],
            url=ATOMS_DATABASE[element]["url"],
        )
...
class ElementShortInfoPanel(wx.Panel):
    ...
    def __init__(self, parent, element="H"):
        ...
        self.family = wx.StaticText(
            self, label="", style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE | wx.EXPAND
        )
        self.family.SetToolTip("Chemical family")
        self.family.SetFont(
            wx.Font(8, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_ITALIC, wx.FONTWEIGHT_BOLD)
        )

        # The element symbol.
        self.symbol = wx.StaticText(
            self, label="", style=wx.ALIGN_LEFT | wx.ST_NO_AUTORESIZE
        )
        ...
        self.position.SetFont(
            wx.Font(8, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD)
        )

        # The element full name.
        self.atom = wx.StaticText(
    ...
    def set_selection(self, element):
        ...
        self.position.SetLabel(
            "%2s,%s,%s" % (info["group"], info["period"], info["block"])
        )
    ...
    def __init__(self, parent):
        ...
        for i in _COLS:
            ...
            mainSizer.Add(
                wid,
                (0, i),
                flag=wx.ALL | wx.ALIGN_CENTER | wx.FIXED_MINSIZE | wx.EXPAND,
                border=1,
            )
